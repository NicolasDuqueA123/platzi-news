...
class OpenAIAnalyzer:
    """Analyzer using gemini for news questions.

    This class handles the analysis of news articles using Gemini's GPT models
    ...
    def analyze(self, articles: list[Article], question: str) -> str:
        ...
        Returns:
            The answer generated by Gemini.
        ...
        try:
            ...
            msg = (
                ...
                "Verifique su conexión a internet y la clave de API de Gemini."
            )
